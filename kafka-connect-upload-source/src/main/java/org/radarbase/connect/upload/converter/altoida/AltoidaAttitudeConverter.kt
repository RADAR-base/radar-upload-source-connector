...
class AltoidaAttitudeCsvProcessor(
        override val schemaType: String = "_ATT.csv",
        val topic: String = "connect_upload_altoida_attitude") : AbstractCsvProcessor(schemaType) {
